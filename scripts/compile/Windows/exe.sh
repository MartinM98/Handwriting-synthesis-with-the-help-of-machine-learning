...
pyinstaller --windowed --noconsole --onedir --noconfirm "scripts/compile/Windows/Bachelor_Thesis_dir.spec"
...
# pyinstaller --windowed --noconsole --onefile --noconfirm "scripts/compile/Windows/Bachelor_Thesis.spec"