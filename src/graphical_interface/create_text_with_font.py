...
class TextImageRenderAll:
    ...
    def create_image_static_constant(self):
        ...
        # result.show()
        result_image.save('/Users/martin/Desktop/testimage.png')
...
directory_path = '/Users/martin/Desktop/letters_dataset/'
width = 300
height = 300
font_size = 60
text_to_render = 'Hey guys I am Martin and I want to give you some hints regarding remote learning this is a hard way of achieving engineer degree'
text_renderer = TextImageRenderAll(directory_path, width, height, font_size, text_to_render)
text_renderer.create_image_static_constant()
